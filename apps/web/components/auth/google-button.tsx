...
/**
 * Botão "Continuar com Google". Usa navegação top-level (href) em vez de fetch:
 * o OAuth precisa de um redirect de página inteira para o Google.
 */
export function GoogleButton({ label }: { label: string }) {
  return (
    <a
      href={`${API_URL}/auth/google`}
      className="btn btn-outline w-full gap-2 rounded-full border-white/15 text-neutral-content hover:border-white/30 hover:bg-white/5"
    >
